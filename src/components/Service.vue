...
onMounted(() => {
  ...
  const videoElement = document.querySelector(`#${props.sectionId} video`)
  const archElement = document.querySelector(`#${props.sectionId}`)
  ...
  ScrollTrigger.create({
    ...
    onEnter: () => {
      ...
      gsap.to(`#${props.sectionId} .crumb h3`, {
        x: 0,
        y: 0,
        scale: '1',
        color: '#d38c37',
        ...
        .dropdown {
          ...
          .dropdown-content {
            ...
            .inner-container {
              ...
              .content-text {
                p {
                  font-size: clamp(14px, 12.5437px + 0.3883cqi, 20px);
                  line-height: 1.2;
                  color: #979797;
                  margin: 0 0 0.6em 0;
